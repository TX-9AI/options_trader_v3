"""
data/open_interest.py  v1.0
Real open interest, fetched once per session over REST. GEX has never had it.

v1.0  2026-08-19  Backported from options_trader_v4 r19. OTV3 is still the
        repo the fleet trades, so the collection starts HERE - the v4 copy
        collects nothing until the fleet is repointed, and the two-week wait
        for real GEX only starts when data starts accumulating.
