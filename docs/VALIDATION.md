# VALIDATION — replay, calibration, and the backtest harness

How Layer-1 is validated and calibrated against tape, and how to run the offline backtest harness.
...
<!-- ================= was: docs/README_offline_backtest_harness.md ================= -->
